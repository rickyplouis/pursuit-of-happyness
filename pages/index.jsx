...
const HomepageHeading = ({ mobile }) => (
  <Container text>
    ...
    <Header
      as="h2"
      content="Data visualizations of happyness around the world"
      inverted
      style={{
...
const yearOptions = ["2019", "2018", "2017", "2016", "2015"].map((year) =>
  Object.assign({}, { key: year, value: year, text: year })
);

const HomepageLayout = () => {
  const [country, setCountry] = useState("United States");
  const [year, setYear] = useState("2019");
  const [countries, setCountries] = useState(getAllCountries(year));
        ...
        <Grid container stackable verticalAlign="middle">
            ...
            <Grid.Column width={6}>
              ...
              <span>
                <Dropdown
                  ...
                  selection
                  onChange={(evt, { value }) => handleYear(value)}
                  options={yearOptions}
                  value={year}
                />
              </span>
          ...
          <Grid.Row>
            <Grid.Column textAlign="center">
              <Button size="huge">See All Countries</Button>
            </Grid.Column>
          </Grid.Row>
        </Grid>
      </Segment>
